...
# <img src="https://github.com/leylasrknt/HTS_Analysis/assets/77142451/af785e94-597e-4241-90b5-7b58ad3ba8c3" alt="Project Logo" width="80">  HTS Analysis (BULK RNA SEQ) 

1. **[SRA_download_file.sh](https://github.com/username/repository-name/blob/main/SRA_download_file.sh):** This script automates the process of downloading sequencing data from the Sequence Read Archive (SRA), a publicly available repository of high-throughput sequencing data. 
